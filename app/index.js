...
client.user.setActivity(`HezoyyMusıc ` , { type: 'LISTENING' }); //+ client.guilds.cache.size + ` Sunucu | ` + client.guilds.cache.reduce((a, b) => a + b.memberCount, 0).toLocaleString() + ` Kullanıcı`
});
client.login(fynx.fynxtoken)
.then(function() {
console.log('[TimsahTim] Token Doğru, Bot Aktif Ediliyor.')
}, function(err) {
console.log("[Hata] TokeninizYanlış, Bot Akitf Edilemiyor.")
